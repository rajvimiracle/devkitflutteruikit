  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Scale Transform",style: TextStyle(color: Theme.of(context).primaryColorDark,fontSize: 20,fontWeight: FontWeight.w600),),
      ...
      body: Container(
        ...
        Padding(padding: EdgeInsets.only(top: 6.w,left: 5.w,right: 5.w),
          child: Column(
            ...
            children: [
              Text("Scale Transform",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 12.sp),),
              Text("This is the example of Scale Transform on conitner ",style: TextStyle(color: Colors.black54),),
              SizedBox(height: 2.h,),
